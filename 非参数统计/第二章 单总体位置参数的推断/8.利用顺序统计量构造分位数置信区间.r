...
data <- c(82,53,70,73,103,71,69,80,54,38,87,91,62,75,65,77)

conintervalbyos(data,0.05,0.5)

##书上程序有问题，自己写了个函数，没想到第一次写的函数里头还套了个函数，发现这样也可以，HAHAHA
##——2016年9月22日 21:24 于东北师范大学图书馆 三楼文科阅览室 
